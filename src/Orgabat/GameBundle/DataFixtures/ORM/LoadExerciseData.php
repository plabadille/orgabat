...
class LoadExerciseData implements FixtureInterface, OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        $data = [
            ...
            [ 'Jeu 2A', 9, 'Communication', 6, 0, 0, 'Identifier les instances de prévention dans mon environnement  professionnel' ],
            ...
            [ 'Jeu 3E', 5, 'Manutention et postures au travail', 19, 0, 0, 'Identifier les bonnes et les mauvaises postures au travail.' ],
            [ 'Jeu 1F', 17, 'Protection', 9, 0, 9, 'Proposer des mesures de prévention adaptées à chaque situation en s\'appuyant sur les principes généraux de prévention.' ],
            [ 'Jeu 2F', 15, 'Protection', 5, 0, 0, 'Choisir les équipements de protection individuel nécessaire à la réalisation de l’activité professionnelle.' ],
            [ 'Jeu 3F', 23, 'Protection', 14, 9, 1, 'Analyser la situation de travail, évaluer le risque d’accident et secourir la victime.' ],
